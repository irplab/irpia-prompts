...
from app.services.llm.vigogne.vigogne_instruct_kw_suggestion_engine import \
    VigogneInstructKwSuggestionEngine
...
class VigogneInstructKwSuggestionServiceFactory(SuggestionServiceFactory):
    ...
    def _suggestion_engine(cls, engine_settings: dict) -> SuggestionEngine:
        return VigogneInstructKwSuggestionEngine(engine_settings=engine_settings)
